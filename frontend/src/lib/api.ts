...
export const attendanceApi = {
  ...
  getGeoSettings:    () => peopleClient.get('/attendance/geo-config/settings').then((r) => r.data.data),
  updateGeoSettings: (data: { enabled: boolean }) => peopleClient.put('/attendance/geo-config/settings', data).then((r) => r.data.data),
  getGeoConfig:      () => peopleClient.get('/attendance/geo-config').then((r) => r.data.data),
  addGeoConfig:      (data: unknown) => peopleClient.post('/attendance/geo-config', data).then((r) => r.data.data),
  deleteGeoConfig:   (configId: string) => peopleClient.delete(`/attendance/geo-config/${configId}`).then((r) => r.data.data),
  getGeoZoneSettings:    () => peopleClient.get('/attendance/geo-zones/settings').then((r) => r.data.data),
  updateGeoZoneSettings: (data: { enabled: boolean }) => peopleClient.put('/attendance/geo-zones/settings', data).then((r) => r.data.data),
  ...
  rejectWfhRequest:  (id: string, data: unknown) => peopleClient.patch(`/attendance/wfh-requests/${id}/reject`, data).then((r) => r.data.data),
...
export const timeEntriesApi = {
  ...
  orgAnalytics:  (params?: Record<string, string>) => timeClient.get('/entries/analytics/org', { params }).then((r) => r.data.data),
