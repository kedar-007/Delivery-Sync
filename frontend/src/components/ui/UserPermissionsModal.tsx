...
const PERM_GROUPS: PermGroup[] = [
  ...
  },
  {
    ...
    perms: [
      ...
      { key: 'EMPLOYEE_RECORD_READ',  label: 'View Employee Records', desc: 'View employees\' joining date, employee ID, bank account and emergency contact details (People Settings → Employee Records)' },
      { key: 'EMPLOYEE_RECORD_WRITE', label: 'Edit Employee Records', desc: 'Edit employees\' joining date, employee ID, bank account and emergency contact details' },
  ...
  },
  {
    ...
    perms: [
      ...
      { key: 'ADMIN_JOBS_VIEW',     label: 'View Background Jobs',  desc: 'See execution history, status and errors of all background jobs and crons' },
...
const CRUD_MODULES: CrudSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'Background Jobs',  view:  'ADMIN_JOBS_VIEW' },
...
const PERM_INFO: Record<string, { label: string; desc: string }> = {
  ...
  EMPLOYEE_RECORD_READ:  { label: 'View',  desc: 'View employees\' joining date, employee ID, bank account and emergency contact details' },
  EMPLOYEE_RECORD_WRITE: { label: 'Edit',  desc: 'Edit employees\' joining date, employee ID, bank account and emergency contact details' },
  ...
  ADMIN_JOBS_VIEW:     { label: 'View',    desc: 'See execution history, status and errors of all background jobs and crons' },
