...
router.get('/me/resume',      RBACMiddleware.require(PERMISSIONS.PROFILE_READ),  (req, res) => ctrl(req).serveResume(req, res));
...
router.get('/:userId/resume', RBACMiddleware.require(PERMISSIONS.PROFILE_READ),  (req, res) => ctrl(req).serveResume(req, res));
