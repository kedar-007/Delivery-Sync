...
const app = express();
const PREFIX = '/server/doc_service';

app.use(express.json({ limit: '20mb' })); // larger limit for base64 file uploads
...
app.use((err, req, res, _next) => {
  console.error('[DocService Error]', err.message, err.stack);
