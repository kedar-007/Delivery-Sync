...
const PERMISSIONS = Object.freeze({
  ...
  // Feature Releases (What's New) — everyone reads, admins author
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.DELIVERY_LEAD]: [
    ...
    PERMISSIONS.ANNOUNCEMENT_READ, PERMISSIONS.FEATURE_RELEASE_READ,
  ...
  [ROLES.PMO]: [
    ...
    PERMISSIONS.PROFILE_READ,
    PERMISSIONS.ANNOUNCEMENT_READ, PERMISSIONS.FEATURE_RELEASE_READ, PERMISSIONS.ANNOUNCEMENT_WRITE,
